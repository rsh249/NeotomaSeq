...
#Use conda R 3.5 'conda install -c r r-base' unless R3.5 is already available
#jobdir=$1
taxsearch=$1
...
#bwa aln -t 8 -i 0 -o 2 -n 0.02 -l 1024 -e 7 $taxsearch.fa *.filtered > $taxsearch.sai
#bwa samse $taxsearch.fa $taxsearch.sai *.filtered
