...
#Trim to top 10 families across samples

trimtaxa = unique(eutaxadf[order(-(eutaxadf$count/eutaxadf$Total)),'family'][1:100])[1:10]
ttaxadf = eutaxadf[which(eutaxadf$family %in% trimtaxa),]
